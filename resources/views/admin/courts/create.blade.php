        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="{{ route('courts.create') }}" class="kt-subheader__breadcrumbs-link">
                        إضافة محكمة قضائية
                    </a>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="kt-portlet">
                ...
                <!--begin::Form-->
                <form class="kt-form kt-form--label-right" id="frmAdd" method="post" action="{{ route('courts.store') }}">
