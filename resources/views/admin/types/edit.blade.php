        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="{{ route('types.edit', $id) }}" class="kt-subheader__breadcrumbs-link">
                        تعديل نوع دعوى قضائية
                    </a>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="kt-portlet">
                ...
                <!--begin::Form-->
                <form class="kt-form kt-form--label-right" id="frmEdit" method="post" action="{{ route('types.update', $id) }}">
                    @csrf
                    @method('PATCH')
